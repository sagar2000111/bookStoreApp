  ...
  return (
    ...
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10">
        <div className="w-full order-2 md:order-1 md:w-1/2 mt-12 md:mt-32">
            ...
            <p className="text-xl font-bold">Lorem,ipsum dolor sit amet consectetur adipisicing elit.Dolor, et
                totam. Tempora amet atque expedite, quae corrupti totam sed pariatur
                corporis at veniam est voluptas amimi!
            </p>
